export default ({ authGuard, guestGuard }) => [
  ...
  ...authGuard([
      ...
      ] },
    {
      path: '/patients',
      name: 'patients.list',
      component: require('~/pages/patients/list.vue')
    },
    {
      path: '/patients/:id',
      name: 'patient-show',
      component: require('~/pages/patients/patient-show.vue')
    },
    {
      path: '/patients/:id/instance/:instanceId',
      name: 'inst-preview',
      component: require('~/pages/patients/patientImage.vue')
    }
  ]),
